...
<script src="../../assets/js/xschange/yhxq.js"></script>
...
var getrjmc;//字符串形式
	window.onload = function() {
		...
		wentiquery("问题查询按钮1", gethy, getzy, getrjmc, option4.text(), option5, option6.text(), "用户需求");
	};
	...
	$(window.parent.frames["middleTopFrame"].document).find("#rjmc").change(function() {
						if (getrjmc != "请选择") {
							...
							queryDataBarAndPie("软件问题图表数据查询", gethy, getzy, getrjmc, "用户需求");
							barshow();
							queryDataBarAndPie("子页面图表数据查询pie1", gethy, getzy, getrjmc, "用户需求");
							pieshow1();
							queryDataBarAndPie("子页面图表数据查询pie", gethy, getzy, getrjmc, "用户需求");
							pieshow();
						} else {
							gethzunitname();
							 getrjmc1 = [ getrjmc ];
	...
	var tableToExcel = (function() {
		...
		return function(table, filename, sheetname) {
			...
			a.attr("download", '用户需求表'); //这里是关键所在,当点击之后,设置a标签的属性,这样就可以更改excel文件的名字了
	...
	<div id="right">
		...
		<div class="xschange" id="wtcx">
			...
			<ul id="myTab" class="nav nav-tabs">
				<li class="active"><a href="#nsolve" data-toggle="tab" id="nso">未解决</a>	</li>
...
<script type="text/javascript">
	$("#allsoft").click(function() {
		//queryDataBarAndPie("图表数据查询", gethy, getzy, getrjmc, "用户需求");
	});
	...
	/* $("#qsoft").click(function() {
		...
		$("#btns").css("display", "none");
			...
			queryDataBarAndPie("图表数据查询", gethy, getzy, getrjmc, "用户需求");
			barshow();
			queryDataBarAndPie("图表数据查询pie1", gethy, getzy, getrjmc, "用户需求");
			pieshow1();
			queryDataBarAndPie("图表数据查询pie", gethy, getzy, getrjmc, "用户需求");
			pieshow();
	}) */
