...
//............修改表格内................修改表格内.........修改表格内..........修改表格内容.............修改表格内.............修改表格内.................修改表格内................
	  ...
	  function openModal() {
		...
		function getIPPort(operator1){
		 ...
		 $("#tab2").on("click","#but",function(){
			...
			//alert("http://" + test +":"+mport+ "/swsrvphoto/" + ff );
			console.log(ff);	
			if(ff=="null"||ff==""||ff==undefined){
				...
				ipPort=ipPort.replace("\"", "");
				console.log("http://"+ ipPort+ "/swsrvphoto/" + ff);
